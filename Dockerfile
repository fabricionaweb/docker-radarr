...
ARG VERSION
ADD https://github.com/Radarr/Radarr/archive/refs/tags/v$VERSION.tar.gz /tmp/source.tgz
...
ARG BRANCH
ARG VERSION
RUN dotnet build ./src/Radarr.sln \
...
PackageAuthor=[fabricionaweb](https://github.com/fabricionaweb/docker-radarr)
UpdateMethod=Docker
Branch=$BRANCH
